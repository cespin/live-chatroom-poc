...
class OneSpecificVideo extends Component {
  ...
  rosterCallback = (newRoster) => {
    ...
    for (attendeeId in newRoster) {
      if (this.props.whoseVideo === attendeeId) {
  ...
  render() {
    ...
    return (
      <div className="cam" onMouseEnter={this.handleMouseEnter.bind(this)} onMouseLeave={this.handleMouseLeave.bind(this)}>
        ...
        <span className={`cam__meta${metaCls}`} id={`${this.props.whoseVideo}`}>
          You
          <span className={`${micMuteCls} btn--mic`} data-id={this.props.whoseVideo}>
